...
{
    [self limitTextLength:length block:nil];
}

- (void)limitTextLength:(int)length block:(EditEndBlock)block {
    
    if (!objc_getAssociatedObject(self, (__bridge const void *)(kLimitTextLengthKey))) {
    ...
    {
        objc_setAssociatedObject(self, (__bridge const void *)(kLimitTextLengthKey), nil, OBJC_ASSOCIATION_ASSIGN);
        objc_setAssociatedObject(self, (__bridge const void *)(kLimitTextLengthKey), [NSNumber numberWithInt:length], OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }    
    
#if DEBUG
    NSLog(@"textfield limit length:%@",objc_getAssociatedObject(self, (__bridge const void *)(kLimitTextLengthKey)));
#endif
